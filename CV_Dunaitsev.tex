...
\section{ПРОЕКТЫ}
    ...
    \resumeItem{\textcolor{accent} {\href{https://github.com/dunaitseva/course_project_infosys_bmstuS} {\underline{\normalsize{https://github.com/dunaitseva/course\_project\_infosys\_bmstu}}}}}
    \resumeItemListEnd 
    \resumeSubHeadingListEnd
...
\section{НАВЫКИ}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{\normalsize{Инструменты разработки:}}{ \normalsize{CLion, PyCharm, VS, DataGrip}} \\
     \textbf{\normalsize{Технологии/Фреймворки:}}{\normalsize{ Boost, C++ standart library, STL, GTest, CMake, Linux, Flask, Git, GitHub Actions, HTML, CSS, Bootstrap}} \\
    }}
 \end{itemize}
 \vspace{-15pt}
...
$\sbullet[.75] \hspace{0.1cm}$ {{Имею опты написания тестов}} \hspace{1.6cm} \\
