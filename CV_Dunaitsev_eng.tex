...
\section{EDUCATION}
  ...
  {Bachelor "Computer-aided design systems" - \textbf{CGPA} - \textbf{4.65}}{Moscow, Russia}
...
\resumeSubHeadingListStart
\resumeExpItem {\lineSeparatedText{Sber Robotics Laboratory}{Intern software developer}}{05.2022 - ...}
\resumeItemListStart
\resumeItem{\normalsize{Developed firmwares for ESP32 series SoC microcontrollers using the ESP-IDF framework.}}
\resumeItem{\normalsize{Designed and implemented firmware for ESP32 microcontroller for convenient Wi-Fi module usage. Firmware support the ability to send JSON-formatted commands to the controller through the UART interface.}}
\resumeItem{\normalsize{Researched the problem of unstable Wi-Fi connection in a highly noised environment and proposed a set of solutions regarding both hardware and software.
}}
\resumeItem{\normalsize{Implemented a wireless mesh network using ESP32 controllers and tested it, as a possible solution for unstable Wi-Fi connection issue.}}
\resumeItem{\normalsize{Was engaged in refactoring of the code base for the shuttle system. Developed a more flexible software architecture, which made it possible to simplify the process of maintaining, updating and refining the code.}}
\resumeItemListEnd 
\resumeSubHeadingListEnd
...
\section{PROJECTS}
    ...
    \resumeProjectHeading
    {\href{https://github.com/dunaitseva/finite-diff-method}{\textbf{\large{\underline{Plate thermal conductivity solver}}} \href{Project Link}{\raisebox{-0.1\height}\faExternalLink }} $|$ \large{\underline{C++, CMake, gnuplot, ANSYS}}}{05.2022}
    \resumeItemListStart
    \resumeItem{\normalsize{Created library that provides finite difference method for solving non-stationary heat equation for metal plates with arbitrary geometry and boundary conditions.}}
    \resumeItem{\normalsize{Developed classes for rendering animation of plate heating.}}
