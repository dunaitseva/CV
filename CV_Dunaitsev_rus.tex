...
$\sbullet[.75] \hspace{0.2cm}${{Использовал инструменты динамического анализа кода (valgrind, санитайзеры), а также инструменты статического анализа кода (cpplint, cppcheck, fbinfer, clang-tidy, и т. д.)} \hspace{2.6cm} \\
$\sbullet[.75] \hspace{0.2cm}${{Знания математики: линейная алгебра, теория вероятности, математическая статистика, методы оптимизации. Изучал и реализовывал методы вычислительной математики.}} \\
$\sbullet[.75] \hspace{0.2cm}${{Общие инженерные навыки. Опыт использовния CAD/CAM систем (Siemens NX, Autodesk Inventor).}} \\
$\sbullet[.75] \hspace{0.2cm}${{Английский язык Intermediate.}} \\
